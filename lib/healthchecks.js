...
function checkFunction(protocol, hostname, port, strictSSL, requestID) {
...
module.exports = function healthchecks(options) {
  ...
  const strictSSL    = (_.get(options, 'strictSSL', 'true') === 'true') ? true : false;
  ...
  return function(req, res) {
    ...
    runChecks(protocol, hostname, port, strictSSL, requestID)
      .then(function(outcomes) {
